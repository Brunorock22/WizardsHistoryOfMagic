...
class MainViewPagerAdapter(fa: MainViewPagerFragment, private val wizardsFragment: WizardsFragment, private val spellsFragment: SpellsFragment) : FragmentStateAdapter(fa) {
